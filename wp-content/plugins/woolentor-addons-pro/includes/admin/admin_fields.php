                ...
                array(
                    ...
                    'setting_fields' => array(
                        ...
                        array(
                            ...
                            'html'        => wp_kses_post( '<a href="'.admin_url('edit.php?post_type=woolentor-template&template_type=emails&tabs=emails').'" target="_blank">Create your own customized Email.</a>', 'woolentor' ),
                            'type'        => 'html',
                            'class'       => 'woolentor-action-field-left'
                        ),
