...
class Woolentor_Wl_Related_Product_Widget extends Widget_Base {

    public function get_name() {
        return 'woolentor-related-product-custom';
    }
    
    public function get_title() {
        return __( 'WL: Related Product layout ( Custom ) ', 'woolentor-pro' );
    }
    ...
    public function get_keywords(){
        return ['related','related product','product','custom layout'];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => __( 'Related Product', 'woolentor-pro' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} h2.wlrelated_product_title',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' =>'#444444',
                    'selectors' => [
                        '{{WRAPPER}} h2.wlrelated_product_title' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} h2.wlrelated_product_title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        $related = '';
        if ( !$related = wc_get_related_products( $product->get_id(), $per_page ) ) {
            return;
        }else{
        ...
        if( $settings['related_product_title'] !='' ){
            echo '<div class="ht-row"><div class="ht-col-lg-12 ht-col-md-12 ht-col-sm-12 ht-col-xs-12"><h2 class="wlrelated_product_title">'.esc_html__( $settings['related_product_title'], 'woolentor-pro' ).'</h2></div></div>';
        }
    
        if( $settings['product_layout_style'] == 'slider' ){ echo '<div class="ht-row">'; }
