...
class Woolentor_Universal_Product_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'WL: Universal Product Layout', 'woolentor-pro' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'show_by_tagwise',
                [
                    'label' => __( 'Show Product By Tag Wise', 'woolentor-pro' ),
                    'type' => Controls_Manager::SWITCHER,
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Show Cart Button Text', 'woolentor-pro' ),
                    'type' => Controls_Manager::SWITCHER,
                    'condition'=>[
                        'show_addtocart_button!'=>'yes',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .ht-products .ht-product .ht-product-inner .ht-product-content .ht-product-content-inner .ht-product-categories:not(.ht-product-brand) a',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ht-products .ht-product .ht-product-inner .ht-product-content .ht-product-content-inner .ht-product-categories:not(.ht-product-brand) a' => 'color: {{VALUE}};',
                        '{{WRAPPER}} .ht-products .ht-product .ht-product-inner .ht-product-content .ht-product-content-inner .ht-product-categories:not(.ht-product-brand)::before' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .ht-products .ht-product .ht-product-inner .ht-product-content .ht-product-content-inner .ht-product-categories:not(.ht-product-brand) a:hover' => 'color: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Tab Menu Style', 'woolentor-pro' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => __( 'Tab Menu Area Margin', 'woolentor-pro' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
            ...
            $this->start_controls_tabs('product_tab_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => __( 'Product tab menu background', 'woolentor-pro' ),
                            'type' => Controls_Manager::COLOR,
                            'default' =>'#ffffff',
                            'selectors' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => __( 'Tab Menu padding', 'woolentor-pro' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label' => __( 'Tab Menu margin', 'woolentor-pro' ),
                            'type' => Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
    ...
    protected function render( $instance = [] ) {
        ...
        // Tags Wise
        $product_tags = $settings['woolentor_product_grid_tags'];
        if( is_array( $product_tags ) && count( $product_tags ) > 0 ){
            $query_args['tags'] = $product_tags;
        }
                                    ...
                                    if( $fetchproduct->have_posts() ){
                                        ?>
                                            <li><a class="<?php if($m==1){ echo 'htactive';}?>" href="#woolentortab<?php echo $tabuniqid.esc_attr($m);?>">
                                                <?php echo esc_attr( $prod_cats->name,'woolentor-pro' );?>
                                            </a></li>
                                        <?php
                                    }
                                }
                    ...
                    <?php if( $settings['show_action_button'] == 'yes' ){ if( $settings['action_button_position'] != 'contentbottom' ): ?>
                        <div class="ht-product-action">
                            <ul <?php echo $this->get_render_attribute_string( 'action_btn_attr' ); ?> >
                                ...
                                <?php endif; ?>
                                <?php
                                 if( $settings['show_wishlist_button']!='yes'):
                                ...
                                ?>
                                <?php
                                    if( $settings['show_compare_button']!='yes'):
