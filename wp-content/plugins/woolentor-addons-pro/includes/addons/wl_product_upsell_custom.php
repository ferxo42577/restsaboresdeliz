...
class Woolentor_Wl_Product_Upsell_Custom_Widget extends Widget_Base {

    public function get_name() {
        return 'woolentor-upsell-product-custom';
    }
    
    public function get_title() {
        return __( 'WL: Upsell Product layout ( Custom )', 'woolentor-pro' );
    }
    ...
    public function get_keywords(){
        return ['upsell','upsell product','custom layout'];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => __( 'You may also like…', 'woolentor-pro' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} h2.wlupsell_product_title',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' =>'#444444',
                    'selectors' => [
                        '{{WRAPPER}} h2.wlupsell_product_title' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} h2.wlupsell_product_title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        $upsell = '';
        if ( !$upsell = $product->get_upsell_ids() ) {
            return;
        }else{
        ...
        // Query Argument
        $args = apply_filters( 'woolentor_upsell_display_args', array(
            'post_type'              => 'product',
        ...
        if( $settings['upsell_product_title'] !='' ){
            echo '<div class="ht-row"><div class="ht-col-lg-12 ht-col-md-12 ht-col-sm-12 ht-col-xs-12"><h2 class="wlupsell_product_title">'.esc_html__( $settings['upsell_product_title'], 'woolentor-pro' ).'</h2></div></div>';
        }
