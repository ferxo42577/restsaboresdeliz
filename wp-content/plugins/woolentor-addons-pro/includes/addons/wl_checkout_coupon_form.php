        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '.woocommerce {{WRAPPER}} .woolentor-checkout-coupon-form .coupon-form .form-row-first' => 'width: {{SIZE}}{{UNIT}};margin-right:0;',
                        '.woocommerce {{WRAPPER}} .woolentor-checkout-coupon-form .coupon-form .form-row-first input' => 'width: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '.woocommerce {{WRAPPER}} .woolentor-checkout-coupon-form .coupon-form .form-row-last' => 'width: {{SIZE}}{{UNIT}};margin-bottom:0px;',
                                '.woocommerce {{WRAPPER}} .woolentor-checkout-coupon-form .coupon-form .form-row-last .button' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
